  ...
  return (
    <svg height={height} viewBox="0 0 380 80" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform={`translate(2, 2) scale(${72/80})`}>
        ...
        {/* Dark dividing lines to create the segmented petal look */}
        {/* Horizontal cuts */}
      ...
      {/* ── CANADA text ── centered under H T N boxes */}
              ...
              <>
                {featured && (
                  <div className={loaded ? "s2" : ""} style={{ marginBottom: "1.8rem" }}>
                    {/* HTN CURATED SECTION */}
{curated.length > 0 && (
  <div style={{ maxWidth: 1200, margin: "0 auto", padding: "1.5rem 1rem 0" }}>
...
git add . && git commit -m "AP News style layout with thumbnails" && git push
                    ...
                    <div className="sec-label" style={{ marginBottom: "0.9rem" }}><span className="live-dot
                    " />Featured Story</div>
