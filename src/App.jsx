                            ...
                            {(() => {
                              ...
                              return [
                                ...
                                <a key={label} href={href} target="_blank" rel="noopener noreferrer"
                                  ...
                                  style={{ display: "flex", alignItems: "center", justifyContent: "center", width: 24, height: 24, color: "#3A4A5A", border: "1px solid #1E2A3A", borderRadius: "3px", transition: "color 0.18s, border-color 0.18s", textDecoration: "none" }}
